  ...
  return (
    <>
        ...
        {context.cart.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <button
                className="bg-blue-400 p-2 max-sm:p-3 rounded-md text-white hover:bg-midBlack ease-in-out duration-300 max-sm:text-xs"
      ...
      <div className="fixed flex justify-between items-center bottom-0 right-0 text-xl font-bold p-4 bg-white gap-24 rounded-md max-sm:rounded-none mb-4 mr-4 max-sm:mr-0 max-sm:mb-0 max-sm:w-screen max-sm:text-sm">
        ...
        <button
          className="bg-blue-400 p-2 rounded-md text-white hover:bg-midBlack ease-in-out duration-300 max-sm:text-sm"
          onClick={() => {
